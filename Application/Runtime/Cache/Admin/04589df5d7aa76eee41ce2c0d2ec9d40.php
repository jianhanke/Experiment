	...
	<div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Teacher/addTeacher');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                         <tr>
                                ...
                                <td>
                                    <input class="common-text required" name="Tid" size="20"  type="text">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <!-- <th><i class="require-red">*</i>年龄：</th> -->
                                <td>
                                    <input class="common-text required" name="Tname" size="20"  type="text">
                                </td>
                            </tr>
                          ...
                          <!--   <tr>
                            ...
                            <tr>
                                ...
                                <td><input class="common-text" name="Ttele" size="30"  type="text"></td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>密码:</th>
                                <td><input class="common-text" name="Tpwd" size="30"  type="text"></td>
                            </tr>
                          <!--   <tr>
                                <th>备注：</th>
