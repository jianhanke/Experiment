...
<script type="module" crossorigin="anonymous" >
  ...
  import RFB from '/Experiment/Public/noVNC/core/rfb.js';
   ...
   var rfb = new RFB(document.getElementById('con0'),"<?php echo ($url0); ?>" ,{ credentials: { password: '123456' } }  );
  rfb.connect(); 
</script>
...
<script type="module" crossorigin="anonymous" >
  ...
  var rfb = new RFB(document.getElementById('con1'),"<?php echo ($url1); ?>",{ credentials: { password: '123456' } }  );
  rfb.connect();  
...
<script type="module" crossorigin="anonymous" >
  ...
  var rfb = new RFB(document.getElementById('con2'),"<?php echo ($url2); ?>" ,{ credentials: { password: '123456' } }  );
  rfb.connect();  
...
<script type="module" crossorigin="anonymous" >
  ...
  var rfb = new RFB(document.getElementById('con3'),"<?php echo ($url3); ?>",{ credentials: { password: '123456' } }  );
  rfb.connect();  
