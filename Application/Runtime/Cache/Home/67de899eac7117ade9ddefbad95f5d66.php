    ...
    <div class="leftDiv"  style="height: 100%;width: 34%; float: left; "  >
        ...
        <div class="box" style="height: 90%; width: 100%; " >
            <div class="con0" id="con0"  >                     
                 <img src="/Experiment/Public/Home/images/1.jpg" style="height: 50%;width: 50%;" > 
              </div>
            <div class="con1">
            ...
            <iframe src="http://view.officeapps.live.com/op/view.aspx?src=http://192.168.24.155/Experiment/Course/MySql/MySql%E7%AC%AC%E4%B8%80%E7%AB%A0%E8%8A%82/1.doc" frameBorder=0  style="height: 100%;width: 100%; "   ></iframe>
