		...
		<a href="<?php echo U('Course/joinChapterById');?>/id/<?php echo ($data['id']); ?>" target="block">
			 ...
			 <b   >上传报告</b>
				<form action="<?php echo U('Course/uploadFile');?> " method="post" enctype="multipart/form-data" >
                        ...
                        <?php if($data['upload_id'] != NULL ): ?><font color="green" >(已上传)</font> <a href="<?php echo U('Course/downloadMyReport');?>/reportId/<?php echo ($data['upload_id']); ?>"> <input type="button" value="点击下载"> </a>
                        <?php else: ?>
