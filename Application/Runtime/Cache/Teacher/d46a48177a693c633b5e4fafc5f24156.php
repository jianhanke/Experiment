...
<div class="search-wrap">
            <div class="search-content">
                <form action="<?php echo U('Student/findStudentByLike');?>" method="post">
                    <table class="search-tab">
                        <tr>
                            ...
                            <td>  <a href="<?php echo U('Student/addClassToStudent');?>/classId/<?php echo ($classId); ?>"> <input type="button" value="手动添加学生" > </a>   </td>
