...
--
-- Host: localhost:3306
-- Generation Time: 2019-09-23 21:51:20
...
(1, 'MySql第一章节', '57b6a90d6f8b', 1, 'MySql/MySql第一章节/1.htm', 'MySql/MySql第一章节/1.mp4'),
(2, 'MySql的第二章节', '57b6a90d6f8b', 1, 'MySql/MySql的第二章节/2.htm', 'MySql/MySql的第二章节/2.mp4'),
(3, 'MySql第三个章节', '57b6a90d6f8b', 1, NULL, NULL),
(4, 'Oracle第一个章节', NULL, 2, NULL, NULL),
(5, 'Oracle章节第二个', NULL, 2, NULL, NULL),
(6, 'Oracle章节第三个', NULL, 2, NULL, NULL);
...
('2483c90480a4', 'registry.cn-hangzhou.aliyuncs.com/jianhanke/my_oracle', NULL, 1),
