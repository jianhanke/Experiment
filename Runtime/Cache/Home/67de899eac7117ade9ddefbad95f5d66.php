    ...
    <div class="leftDiv"  style="height: 100%;width: 32%; float: left; "  >
        ...
        <div class="box" style="height: 90%; width: 100%; " >
            <div class="con0" id="con0"  >                
                 <img src="/Experiment10/Public/Home/images/2.jpg" style="height: 20%;width: 100%;" > 
                 <br>
                 
                 <ul class="point2">

                  <!-- <li> <a href="<?php echo U('Docker/resetContainer');?>/id/<?php echo ($id); ?>">  <input type="button" value="重置虚拟机"> </a> </p>  -->
            ...
            <div class="con1">
                <video src="/Experiment10/Source/Chapter/<?php echo ($video); ?>" style="width: 100%;"  controls="" ></video>
            </div>

            <div class="con2" style="height: 90%;" >
                <form action="<?php echo U('Course/saveNote');?> " id="myForm" method="post"  style="height: 80%;"  target="hidden_iframe"  >
            ...
            <?php if(($doc == '')): ?><font  color="red" size="20" >暂时为空 </font>
              <?php else: ?> <iframe src="/Experiment10/Source/Chapter/<?php echo ($doc); ?> " frameBorder=0  style="height: 100%;width: 100%; "   ></iframe><?php endif; ?>
...
<script src="/Experiment10/Public/Home/js/jquery-2.0.0.min.js"></script>
<script src="/Experiment10/Public/Home/plugin/layer/layer.js" ></script>

<script type="module" crossorigin="anonymous" >
  
  import RFB from '/Experiment10/Public/Home/plugin/noVNC/core/rfb.js';
...
<script type="text/javascript" src="/Experiment10/Public/Home/js/Ueditor/ueditor.config.js"></script>
                        <!-- 编辑器源码文件 -->
            <script type="text/javascript" src="/Experiment10/Public/Home/js/Ueditor/ueditor.all.js"></script>
                        <!-- 实例化编辑器 -->
            <script type="text/javascript">
