...
<body>
      <div class="search-wrap">
            <div class="search-content">
                <form action="/Experiment10/index.php/Admin/Course/findImageByLike" method="post">
            ...
            <div class="result-content">
                <table class="result-tab" width="100%">
                 ...
                 <?php if(is_array($datas)): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <a class="link-del" href="/Experiment10/index.php/Admin/Course/deleteChapterImageById/id/<?php echo ($data['id']); ?>">删除</a>
                        </td>
